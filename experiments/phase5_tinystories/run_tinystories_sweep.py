"""
Raw AGNIS — experiments/phase5_tinystories/run_tinystories_sweep.py

Phase 5 Sweep Coordinator for multi-model, multi-seed TinyStories configurations.
"""
...
def run_single_benchmark(args_tuple) -> dict:
    ...
    script_path = os.path.join(os.path.dirname(__file__), "run_tinystories_benchmark.py")
...
def main():
    parser = argparse.ArgumentParser(description="Raw AGNIS Phase 5 TinyStories Sweep Coordinator")
    ...
    parser.add_argument("--config", type=str, default="configs/kaggle_phase5.yaml", help="Custom configuration file path")
