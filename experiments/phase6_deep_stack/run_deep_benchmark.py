...
def main():
    ...
    parser.add_argument("--model", type=str, required=True,
                        choices=['gru_baseline', 'rnn_baseline', 'rnn_replay_baseline', 'gru_replay_baseline',
                                 ...
                                 'sparc_minimum_energy', 'sparc_supervised_router',
                                 'sparc_energy_distilled', 'sparc_learned_distilled',
                                 'sparc_learned_mixture'],
    ...
    if model_key == 'seq_agnis_flat_wide':
        ...
        'sparc_minimum_energy',
        'sparc_supervised_router',
        'sparc_energy_distilled',
        'sparc_learned_distilled',
        'sparc_learned_mixture',
    ]:
        # Map model keys to internal routing modes
        mode_mapping = {
            'sparc_minimum_energy': 'minimum_energy',
            'sparc_supervised_router': 'supervised_router',
            'sparc_energy_distilled': 'energy_distilled_router',
            'sparc_learned_distilled': 'learned_router_distill',
            'sparc_learned_mixture': 'learned_router_mixture',
        }
        from agnis.sequence.sequence_wrapper import SPARCSequenceWrapper
        model = SPARCSequenceWrapper(
            d_in=d_symbol,
            ...
            step_c=0.5,
            n_settle=15,
            routing_mode=mode_mapping[model_key],
        )
    else:
